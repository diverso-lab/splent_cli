...
def _generate_refinement_toml(
    ...
    lines = []
    lines.append("")
    lines.append("# -- Refinement (auto-generated by feature:refine) ---------")
...
@click.command(
    "feature:refine",
    short_help="Interactive wizard to configure how a feature extends another.",
)
...
def feature_refinement(refiner_name):
    ...
    click.echo()
    click.secho("  feature:refine", fg="cyan", bold=True)
